...
public class StageOneLearnPopUpActivityTwo extends Activity implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_stageonelearnpopuptwo);

		answer_frame1 = (LinearLayout) findViewById(R.id.stage1_learn_popup2_blank_layout1);
		answer_frame2 = (LinearLayout) findViewById(R.id.stage1_learn_popup2_blank_layout2);
		answer_frame3 = (LinearLayout) findViewById(R.id.stage1_learn_popup2_blank_layout3);
		answer_frame4 = (LinearLayout) findViewById(R.id.stage1_learn_popup2_blank_layout4);
		answer_frame5 = (LinearLayout) findViewById(R.id.stage1_learn_popup2_blank_layout5);
		answer_frame6 = (LinearLayout) findViewById(R.id.stage1_learn_popup2_blank_layout6);

		answer_piece1 = (ImageView) findViewById(R.id.stage1_learn_popup2_image1);
		answer_piece2 = (ImageView) findViewById(R.id.stage1_learn_popup2_image2);
		answer_piece3 = (ImageView) findViewById(R.id.stage1_learn_popup2_image3);
		answer_piece4 = (ImageView) findViewById(R.id.stage1_learn_popup2_image4);
		answer_piece5 = (ImageView) findViewById(R.id.stage1_learn_popup2_image5);
		answer_piece6 = (ImageView) findViewById(R.id.stage1_learn_popup2_image6);
		...
		findViewById(R.id.stage1_learn_popup2_image_layout1).setOnDragListener(
				mDragListener);
		findViewById(R.id.stage1_learn_popup2_image_layout2).setOnDragListener(
				mDragListener);
		findViewById(R.id.stage1_learn_popup2_image_layout3).setOnDragListener(
				mDragListener);
		findViewById(R.id.stage1_learn_popup2_image_layout4).setOnDragListener(
				mDragListener);
		findViewById(R.id.stage1_learn_popup2_image_layout5).setOnDragListener(
				mDragListener);
		findViewById(R.id.stage1_learn_popup2_image_layout6).setOnDragListener(
				mDragListener);

		nextBtn = (ImageButton) findViewById(R.id.stage1_learn_popup2_next_btn);
		nextBtn.setOnClickListener(this);

		wrongLayout = (RelativeLayout) findViewById(R.id.stage1_learn_popup2_wrong_layout);
		wrongLayout.setVisibility(View.INVISIBLE);
		confirmBtn = (ImageButton) findViewById(R.id.stage1_learn_popup2_wrong_confirm_btn);
	...
	public void onClick(View arg0) {
		if (arg0.getId() == nextBtn.getId()) {
			if (answer_check()) {
				...
				StageOneLearnPopUpActivityTwo.this.finish();
			} else {
		...
		if (count == 4) {
			if (frame1) {
				if (child1 == answer_piece1.getId()) {
					...
					correctCount++;
				} else if (child1 == answer_piece6.getId()) {
					correctCount++;
				}
			}
			if (frame2) {
				if (child2 == answer_piece1.getId()) {
					...
					correctCount++;
				} else if (child2 == answer_piece6.getId()) {
					correctCount++;
				}
			}
			if (frame3) {
				if (child3 == answer_piece1.getId()) {
					...
					correctCount++;
				} else if (child3 == answer_piece6.getId()) {
					correctCount++;
				}
			}
			if (frame4) {
				if (child4 == answer_piece1.getId()) {
					...
					correctCount++;
				} else if (child4 == answer_piece6.getId()) {
					correctCount++;
				}
			}
			if (frame5) {
				if (child5 == answer_piece1.getId()) {
					...
					correctCount++;
				} else if (child5 == answer_piece6.getId()) {
					correctCount++;
				}
			}
			if (frame6) {
				if (child6 == answer_piece1.getId()) {
					...
					correctCount++;
				} else if (child6 == answer_piece6.getId()) {
					correctCount++;
				}
			}
		}
